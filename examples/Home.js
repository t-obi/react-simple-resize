  ...
  render() {
    return (
      <div className={css.Home}>
        ...
        <h2> Why? </h2>
        I needed a resizable container for a small example (see <a href="http://tkloht.github.io/react-video-cover/#/resizable">react-video-cover</a>).
        ...
        You should have a look at the <a href="https://github.com/tkloht/react-simple-resize/blob/master/README.md">readme</a> and the <Link to="/example">example</Link>.
